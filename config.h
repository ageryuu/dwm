...
static const char *fonts[]          = { "Noto Sans:pixelsize=14:type=Regular" };
static const char dmenufont[]       = "Noto Sans:pixelsize=14";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-f    n", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan    , "-sf", col_gray4, NULL };
